        ...
        <div className="row">
          <div className="col-md-12">
            <div className="dev-calltoaction" data-animation-name="fadeInDown">
              ...
              <a className="dev-callbtn" href="http://localhost:3000/" >Learn More</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6">
            ...
            <a href="http://localhost:3000/"  className="devbtn">Read More</a>
          </div>
          <div className="col-md-6">
